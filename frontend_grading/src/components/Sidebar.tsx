...
export function Sidebar({ collapsed }: SidebarProps) {
    ...
    const navigationItems = [
        ...
        { path: "/rubric-upload", label: "Rubric Upload", icon: null },
    ...
    return (
        <div className={`${collapsed ? 'w-0' : 'w-[306px]'} bg-white shadow-lg min-h-screen transition-all duration-300 overflow-hidden`}>
