...
import { Upload, FileText, Loader2, CheckCircle, AlertCircle, Play, ChevronDown, ChevronUp, BookOpen, ServerOff, Menu } from 'lucide-react';
        ...
        <div className="flex min-h-screen bg-gray-50">
            ...
            <div className="flex-1 flex flex-col">
                ...
                <div className="bg-[#cee5ff] p-4 shadow-sm flex items-center gap-3">
                    ...
                    <h1 className="text-xl font-medium">Student Answers</h1>
                </div>

                <div className="flex-1" style={{ padding: '2rem', paddingLeft: '3rem', paddingRight: '3rem' }}>
                    <p className="text-sm text-gray-500 mb-6">Upload student answers and run AI grading against a rubric</p>
